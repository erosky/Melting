...
BEGIN { TOTAL = 2060 ; threshold = 0.54 ; ice = 0 ; start = 0 } 
{
	if ($2=="TIMESTEP") {
		if (start==1) { 
			print step "\t" step*0.00001 "\t" 289+step*0.25*0.00001 "\t" ice "\t" TOTAL-ice "\t" TOTAL "\t" ice/TOTAL
		} ; 
		t = 1 ; a = 0 ; next 
	}
...
END { print step "\t" step*0.00001 "\t" 289+step*0.25*0.00001 "\t" ice "\t" TOTAL-ice "\t" TOTAL "\t" ice/TOTAL }

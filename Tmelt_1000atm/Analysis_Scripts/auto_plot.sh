...
gnuplot -e "set terminal png; \
            ...
            plot for [i=294:301] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:7 title ''.i.'K'; "
...
gnuplot -e "set terminal png; \
            ...
            set key right top ; \
            set style data lines; \
            plot for [i=294:301] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:5 title ''.i.'K'" > ${WORKING_DIR}/Tmelt_TE_all.png
...
gnuplot -e "set terminal png; \
            ...
            set key right top ; \
            set style data lines; \
            plot for [i=294:301] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:8 title ''.i.'K'" > ${WORKING_DIR}/Tmelt_MSD_all.png
...
gnuplot -e "set terminal png; \
            ...
            set key right top ; \
            set style data lines; \
            plot for [i=294:301] 'run_Tmelt_'.i.'K_AUTO.dat' using 1:4 title ''.i.'K'" > ${WORKING_DIR}/Tmelt_VOL_all.png
